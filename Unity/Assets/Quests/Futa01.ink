...
+ <i>Sure, what’s up?
+ <i>Sorry, I’m in a rush! -> leave

- Well, I’m looking for something.
A kind of mushroom...

+ <i>[In the dark?] Hmm, I don’t expect we’ll find much over here in the dark.

- Actually, this mushroom should be easiest to find in the dark. It’s bioluminescent!

+ <i>A glowing mushroom?
...
= approach
{
    - Futa01_has_mushroom:
        ...
        + <i>I have some mushrooms for you\~ -> give_mushrooms
    - else:
        Anything?
        + <i>Nah, nothing yet... -> start
}
...
+ <i>[No problem.] It’s really no problem! I had fun exploring.
...
+ <i>Absolutely, yes.
+ <i>[Actually...] Maybe I’m not the best person to ask for this… Sorry. -> leave

- \(NPC dominant sex encounter until climax)
I would have never imagined having a dick would feel this good.

+ <i>[Wow] Merlin have mercy! That was outstanding!
